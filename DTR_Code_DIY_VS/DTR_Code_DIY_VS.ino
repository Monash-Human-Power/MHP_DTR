...
// -) The output voltage of the generator is measured using a resistor divider of 10k and 100k ohms. 
//    This divides the output voltage of the generator from 0-50V down to 0-5V. Please ensure that the generator
//    does not produce more than 50V, or the arduino will be irreperably damaged. It is advised to always
...
float R1 = 100000.0;           // Value of resistor R1 in voltage measurement sensor
float R2 = 10000.0;            // Value of resistor R2 in voltage measurement sensor
